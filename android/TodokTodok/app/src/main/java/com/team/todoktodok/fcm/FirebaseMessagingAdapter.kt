package com.team.todoktodok.fcm
...
import com.team.core.serialization.toSerialization
import com.team.domain.model.FcmNotification
import com.team.domain.model.FcmNotification.Companion.FcmNotification
...
class FirebaseMessagingAdapter : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        if (message.data.isNotEmpty()) {
            ...
            val intent = intent(fcmNotification)
            val pendingIntent = getPendingIntent(intent, fcmNotification)
            val alert = getAlert(title, body, pendingIntent)
            notifyNotification(fcmNotification, alert)
        }
    }
    ...
    private fun getPendingIntent(
        ...
        val pendingIntent =
            TaskStackBuilder
                ...
                .getPendingIntent(
                    fcmNotification.discussionId.hashCode(),
