...
enum class UserProfileTab(
    ...
    ACTIVATED_BOOKS(R.string.all_active_books),
    CREATED_DISCUSSIONS(R.string.all_created_discussion_room),
    PARTICIPATED_DISCUSSIONS(R.string.all_participated_discussion_room),
    ;
