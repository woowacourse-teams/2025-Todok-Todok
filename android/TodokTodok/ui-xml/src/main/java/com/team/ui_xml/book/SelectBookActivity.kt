...
import com.team.core.extension.addOnScrollEndListener
...
import com.team.ui_xml.book.adapter.SearchBooksAdapter
import com.team.ui_xml.book.vm.SelectBookViewModel
...
import com.team.ui_xml.databinding.ActivitySelectBookBinding
...
class SelectBookActivity : AppCompatActivity() {
    ...
    private fun navigateToCreateDiscussionRoom(book: SearchedBook) {
        ...
        val intent =
            CreateDiscussionRoomActivity.Companion.Intent(
                this,
