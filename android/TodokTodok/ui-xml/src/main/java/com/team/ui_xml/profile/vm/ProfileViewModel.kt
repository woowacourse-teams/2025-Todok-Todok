package com.team.ui_xml.profile.vm
...
import com.team.ui_xml.profile.ProfileUiEvent
import com.team.ui_xml.profile.ProfileUiState
        ...
        fun loadProfile(id: Long) {
            viewModelScope.launch {
                ...
                withLoading {
                    ...
                    _uiState.value =
                        ProfileUiState.Companion.initial(
                            memberId,
                            profile as Profile,
                            books as List<Book>,
