...
class SettingFragment : Fragment(R.layout.fragment_setting) {
    ...
    private fun moveToLogin() {
        val intent =
            AuthActivity.Companion.Intent(requireActivity()).apply {
