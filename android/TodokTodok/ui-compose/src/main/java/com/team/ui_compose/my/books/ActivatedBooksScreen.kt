...
import com.team.ui_compose.preview.MyBooksUiStatePreviewParameterProvider
...
private fun ActivatedBooksEmpty(onClickAction: () -> Unit) {
    ResourceNotFoundContent(
        title = stringResource(R.string.all_not_has_activated_book_title),
        subtitle = stringResource(R.string.all_not_has_activated_book_subtitle),
