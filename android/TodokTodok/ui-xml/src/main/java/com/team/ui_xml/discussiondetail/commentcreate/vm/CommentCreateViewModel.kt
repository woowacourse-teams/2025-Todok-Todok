package com.team.ui_xml.discussiondetail.commentcreate.vm
...
import com.team.ui_xml.discussiondetail.commentcreate.CommentCreateState
import com.team.ui_xml.discussiondetail.commentcreate.CommentCreateUiEvent
...
class CommentCreateViewModel
    ...
    constructor(
        ...
        private val commentCreateState: CommentCreateState =
            CommentCreateState.Companion.create(savedStateHandle.get<Long>(KEY_COMMENT_ID))
