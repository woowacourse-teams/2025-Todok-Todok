...
import com.team.ui_xml.databinding.FragmentCommentCreateBottomSheetBinding
import com.team.ui_xml.discussiondetail.BottomSheetVisibilityListener
import com.team.ui_xml.discussiondetail.commentcreate.vm.CommentCreateViewModel
    ...
    companion object {
        ...
        fun newInstance(
            ...
            CommentCreateBottomSheet().apply {
                arguments =
                    bundleOf(
                        CommentCreateViewModel.Companion.KEY_DISCUSSION_ID to discussionId,
                        CommentCreateViewModel.Companion.KEY_COMMENT_ID to commentId,
                        CommentCreateViewModel.Companion.KEY_COMMENT_CONTENT to commentContent,
                    )
            }
    }
}
