...
import com.team.ui_xml.databinding.ItemUserInformationBinding
import com.team.ui_xml.databinding.PopupMenuReportBinding
        ...
        with(binding) {
            ...
            val message =
                if (content.message.isNullOrEmpty() && item.isMyProfile) {
                    itemView.context.getString(coreR.string.all_message_placeholder)
                } else {
                    content.message
                }
