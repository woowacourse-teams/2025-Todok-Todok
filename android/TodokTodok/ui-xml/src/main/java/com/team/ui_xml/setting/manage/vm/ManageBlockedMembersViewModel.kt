package com.team.ui_xml.setting.manage.vm
...
import com.team.ui_xml.setting.manage.ManageBlockedMembersUiEvent
import com.team.ui_xml.setting.manage.ManageBlockedMembersUiState
    ...
    constructor(
        ...
        fun unblockMember() {
            withLoading {
                ...
                require(memberId != ManageBlockedMembersUiState.Companion.NOT_HAS_SELECTED_MEMBER) { NOT_FOUND_MEMBER }
