...
import com.team.ui_xml.databinding.FragmentCommentsBinding
...
import com.team.ui_xml.discussiondetail.commentdetail.CommentDetailFragment
import com.team.ui_xml.discussiondetail.comments.adapter.CommentAdapter
...
class CommentsFragment : Fragment(R.layout.fragment_comments) {
    ...
    private fun buildCommentArgs(): Bundle {
        ...
        return Bundle().apply {
            putLong(
                CommentsViewModel.Companion.KEY_DISCUSSION_ID,
                args.getLong(CommentsViewModel.Companion.KEY_DISCUSSION_ID),
            )
        }
    }
            ...
            override fun onReplyClick(commentId: Long) {
                parentFragmentManager.commit {
                    ...
                    add(
                        ...
                        CommentDetailFragment.Companion.newInstance(viewModel.discussionId, commentId),
                        CommentDetailFragment.Companion.TAG,
                    )
                    addToBackStack(null)
                }
            }
    ...
    companion object {
        ...
        fun newInstance(discussionId: Long): CommentsFragment =
            CommentsFragment().apply {
                arguments =
                    bundleOf(
                        CommentsViewModel.Companion.KEY_DISCUSSION_ID to discussionId,
                    )
            }
    }
}
