...
import com.team.ui_xml.databinding.ActivitySettingBinding
import com.team.ui_xml.setting.manage.ManageBlockedMembersFragment
import com.team.ui_xml.setting.modify.ModifyProfileFragment
import com.team.ui_xml.setting.vm.SettingViewModel
import com.team.ui_xml.setting.withdraw.WithdrawFragment
    ...
    private fun changeFragment(screen: SettingScreen) {
        val fragment =
            when (screen) {
                ...
                SettingScreen.WITHDRAW -> WithdrawFragment.Companion.newInstance()
            }
