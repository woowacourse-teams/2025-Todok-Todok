package com.team.ui_compose.discussion.search
...
import com.team.ui_compose.discussion.model.DiscussionResult
import com.team.ui_compose.preview.SearchDiscussionsUiStatePreviewParameterProvider
...
private fun EmptySearchResults(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = coreR.drawable.img_mascort),
...
private fun SearchResultDiscussions(
        ...
        rememberLauncherForActivityResult(
            ...
            if (result.resultCode == RESULT_OK) {
                result.data?.let { data ->
                    when (val result = DiscussionResult.Companion.fromIntent(data)) {
    ...
    LazyColumn(
        ...
        item {
            Text(
                stringResource(coreR.string.all_search_result_count).format(uiState.discussions.size),
