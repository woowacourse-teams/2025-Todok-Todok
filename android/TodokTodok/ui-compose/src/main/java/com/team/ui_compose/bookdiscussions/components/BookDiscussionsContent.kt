...
import com.team.ui_compose.bookdiscussions.model.BookDetailSectionUiState
...
fun BookDiscussionsContent(
    ...
    LazyColumn(
        ...
        bookDiscussionsSectionItems(bookDiscussionsSectionUiState, onDiscussionClick)
    }
}
...
private fun LazyListScope.bookDiscussionsSectionItems(
    ...
    items(
        ...
        DiscussionCard(item, onActionClick)
        Spacer(Modifier.height(20.dp))
    }
