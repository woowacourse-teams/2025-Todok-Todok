package com.team.ui_xml.discussiondetail.replycreate.vm
...
import com.team.ui_xml.discussiondetail.replycreate.ReplyCreateState
...
class ReplyCreateViewModel
    ...
    constructor(
        ...
        private val replyCreateState =
            ReplyCreateState.Companion.create(savedStateHandle.get<Long>(KEY_REPLY_ID))
