package com.team.ui_xml.notification
...
import com.team.ui_xml.databinding.ActivityNotificationBinding
import com.team.ui_xml.discussiondetail.DiscussionDetailActivity
import com.team.ui_xml.notification.adapter.NotificationAdapter
import com.team.ui_xml.notification.adapter.NotificationGroup
import com.team.ui_xml.notification.vm.NotificationViewModel
...
class NotificationActivity : AppCompatActivity() {
        ...
        viewModel.uiEvent.observe(this) { uiEvent ->
            when (uiEvent) {
                is NotificationUiEvent.NavigateToDiscussionRoom -> {
                    val intent = DiscussionDetailActivity.Companion.Intent(this, uiEvent.discussionRoomId)
    ...
    private fun navigationToMain() {
        mainNavigation.navigateToMainForNotificationResult(this, launcher)
    }
