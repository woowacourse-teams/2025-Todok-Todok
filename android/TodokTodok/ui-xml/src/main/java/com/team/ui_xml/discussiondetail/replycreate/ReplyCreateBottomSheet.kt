    ...
    companion object {
        ...
        fun newInstance(
            ...
            ReplyCreateBottomSheet().apply {
                arguments =
                    bundleOf(
                        ReplyCreateViewModel.Companion.KEY_DISCUSSION_ID to discussionId,
                        ReplyCreateViewModel.Companion.KEY_COMMENT_ID to commentId,
                        ReplyCreateViewModel.Companion.KEY_REPLY_ID to replyId,
                        ReplyCreateViewModel.Companion.KEY_REPLY_CONTENT to content,
                    )
            }
    }
}
